...
@Component({
  selector: 'app-edit_breaktype',
  templateUrl: './edit_breaktype.component.html',
  styleUrls: ['./edit_breaktype.component.css']
})
export class EditBreakTypeComponent implements OnInit {
  ...
  public content=[];
  public type=[];
  public break=JSON.parse(localStorage.getItem("breakUpdate"))
  ...
  submit() {
    console.log(this.break)
    this.userService.updateBreakType(this.break).subscribe(item => {
