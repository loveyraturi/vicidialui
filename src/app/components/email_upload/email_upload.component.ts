...
@Component({
  selector: 'app-email_upload',
  templateUrl: './email_upload.component.html',
  styleUrls: ['./email_upload.component.css']
})
export class EmailUploadComponent implements OnInit {
  ...
  submit({ value }: any): void {
    ...
    formData.append('campaingName',this.registerform.get('campaing').value);
    this.campaingService.uploadEmails(formData).subscribe(resp=>{
      console.log(resp,"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
