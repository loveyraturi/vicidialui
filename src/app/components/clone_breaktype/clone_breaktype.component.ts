...
@Component({
  selector: 'app-clone_breaktype',
  templateUrl: './clone_breaktype.component.html',
  styleUrls: ['./clone_breaktype.component.css']
})
export class CloneBreakTypeComponent implements OnInit {
  ...
  public content = [];
  public type = [];
  public break = JSON.parse(localStorage.getItem("breakClone"))
  ...
  submit() {
    console.log(this.break)
    this.userService.cloneBreakType(this.break).subscribe(item => {
